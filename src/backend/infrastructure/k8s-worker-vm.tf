...
output "k8s_worker_group_ips" {
  description = "Internal IP addresses of k8s workers"
  value       = [for vm in yandex_compute_instance.k8s_worker_group : vm.network_interface[0].ip_address]
}